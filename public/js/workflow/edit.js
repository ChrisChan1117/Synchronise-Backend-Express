    ...
    var Workflow = React.createClass({
        ...
        removeComponent: function (index) {
            ...
            for (var i = 0; i < components_modified.length; i++) {
                ...
                for (var j = 0; j < keys.length; j++) {
                    ...
                    if (input.from.id_component == componentToBeRemoved.id_component && input.from.index == componentToBeRemoved.order) {
            ...
            for (var i = 0; i < copyOutputs.length; i++) {
                ...
                if (output.association) {
                    if (output.association.parent == componentToBeRemoved.id_component && componentToBeRemoved.order == output.association.index_parent) {
        ...
        nameInputChanged: function (fromName, toName) {
            ...
            for (var i = 0; i < copyComponents.length; i++) {
                ...
                for (var j = 0; j < Object.keys(row.inputs).length; j++) {
                    ...
                    if (rowInput.from.name == fromName && rowInput.from.id_component == "workflow") {
        ...
        render: function () {
            ...
            if (!this.state.components.length && !this.state.loading) {
                messageIfNoComponents = React.createElement(
                    "div",
                    { className: "card", style: { textAlign: "center" } },
                    "There is no components selected for this workflow. Please select a component from the ",
                    React.createElement(
                        "b",
                        { style: { cursor: "pointer" }, onClick: this.highlightCatalog },
                        "catalog"
                    )
                );
            }
            ...
            if (this.state.components.length) {
                components = React.createElement(Components, { inputs: target.state.inputs,
            ...
            if (this.state.components.length) {
                ...
                timeline = React.createElement("div", { id: "timeline" });
            } else if (!this.state.components.length && !this.state.loading) {
                // There is no component in this workflow
                marginTopFlow = "40px";
            }
            ...
            contentWorkflow = React.createElement(
                "div",
                null,
                React.createElement(WorkflowInput, { inputs: this.state.inputs,
                ...
                React.createElement(
                    "div",
                    { className: "row flow", align: "center", style: { marginTop: marginTopFlow } },
                    loader,
                    React.createElement(
                        "div",
                        { className: "col-xs-10 col-xs-offset-1", style: { paddingBottom: paddingBottom } },
                        timeline,
                        messageIfNoComponents,
                        components
                    )
                ),
                React.createElement(WorkflowOutput, { outputs: this.state.outputs,
                ...
                React.createElement("div", { id: "maskTimelineBottom" })
            );
            ...
            if (this.state.helpActivated) {
                helpToggleButton = React.createElement(
                    "div",
                    { className: "btn-group" },
                    React.createElement(
                        "label",
                        { className: "btn btn-xs btn-default active", onClick: this.toggleHelp.bind(null, true) },
                        "on"
                    ),
                    React.createElement(
                        "label",
                        { className: "btn btn-xs btn-default", onClick: this.toggleHelp.bind(null, false) },
                        "off"
                    )
                );
            } else {
                helpToggleButton = React.createElement(
                    ...
                    React.createElement(
                        "label",
                        { className: "btn btn-xs btn-default", onClick: this.toggleHelp.bind(null, true) },
                        "on"
                    ),
                    React.createElement(
                        "label",
                        { className: "btn btn-xs btn-default active", onClick: this.toggleHelp.bind(null, false) },
                        "off"
                    )
                );
            }
                ...
                exportBlockForExecutionPanel = React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { id: "export", className: "row-fluid", style: { paddingTop: "20px" } },
                                React.createElement(
                                    "div",
                                    ...
                                    React.createElement(
                                        ...
                                        null,
                                        "Export in your app ",
                                        React.createElement("i", { style: { position: "absolute", cursor: "pointer", right: "-14px", top: "0px" }, className: "fa fa-times fa-5 visible-xs visible-sm", onClick: this.hideExecutionPanel })
                                    ),
                                    React.createElement(Export, { loading: false, id: this.state.identifier, inputs: this.state.inputs })
                                ),
                                React.createElement(
                                    "div",
                                    { className: "col-md-6 col-xs-12" },
                                    React.createElement(
                                        ...
                                        React.createElement(
                                            ...
                                            execution_duration,
                                            "s to execute  ",
                                            React.createElement("i", { style: { position: "absolute", cursor: "pointer", right: "-14px", top: "0px" }, className: "fa fa-times fa-5 hidden-xs hidden-sm", onClick: this.hideExecutionPanel })
                                        )
                                    ),
                                    React.createElement(
                                        "div",
                                        { id: "resultJson", style: { border: "1px solid #47B04B", borderRadius: "5px", minHeight: "50px", backgroundColor: "rgba(183, 221, 185, 0.37)", padding: "10px", color: "black" } },
            ...
            if (this.state.execution_status == 3) {
                // Done and error
                var execution_duration = (this.state.end_execution.getTime() - this.state.start_execution.getTime()) / 1000;
                var errorString = "";
                if (this.state.error.type == "component") {
                    errorString = React.createElement(
                        "div",
                        { style: { fontFamily: "monospace" } },
                        React.createElement(
                            "p",
                            { style: { color: "black" } },
                            "The execution of a component failed"
                        ),
                        React.createElement(
                            "p",
                            { style: { color: "black" } },
                            "Component name : ",
                            this.state.componentsData[this.state.error.id].name
                        ),
                        React.createElement(
                            "p",
                            { style: { color: "black" } },
                            "Index of the component : ",
                            this.state.error.index + 1
                        ),
                        React.createElement(
                            "p",
                            { style: { color: "black" } },
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        "legend",
                                        null,
                                        "Uh oh. Let see what happened there. ",
                                        React.createElement(
                                            "span",
                                            { className: "pull-right" },
                                            execution_duration,
                                            ...
                                            React.createElement(
                                                "button",
                                                { className: "btn btn-primary btn-xs", onClick: this.actionToFixError },
                                                "Fix now"
                                            )
                                        )
                                    ),
                                    React.createElement(
                                        "div",
                                        { id: "resultJson", style: { border: "1px solid #EC2F2A", borderRadius: "5px", minHeight: "50px", backgroundColor: "rgba(243, 193, 191, 0.33)", padding: "10px" } },
                                        errorString
                                    )
                                )
                            )
            ...
            if (this.state.execution_status == 1) {
                // Executing
                progressBlockForExecutionPanel = React.createElement(
                    "div",
                    { className: "row-fluid" },
                    React.createElement(
                        "div",
                        { style: { textAlign: "center" }, className: "col-xs-12" },
                        React.createElement(
                            "h4",
                            null,
                            this.state.executionCurrentProgress,
                            "%"
                        )
                    ),
                    React.createElement(
                        ...
                        React.createElement(
                            "div",
                            { className: "progress", style: { marginTop: "20px", borderRadius: "5px" } },
                            React.createElement("div", { className: "progress-bar progress-bar-primary", role: "progressbar", "aria-valuenow": this.state.executionCurrentProgress, "aria-valuemin": "0", "aria-valuemax": "100", style: { width: this.state.executionCurrentProgress + "%" } })
                        )
                    )
                );
            }
            ...
            return React.createElement(
                "div",
                null,
                React.createElement("div", { id: "shadowForExecutionPanel", style: { display: "none", position: "fixed", top: 0, left: 0, width: "100%", height: "100%", background: "rgba(0,0,0,0.5)", zIndex: 1000, opacity: 0 } }),
                React.createElement(
                    "span",
                    { className: "pull-right",
                    ...
                    React.createElement(
                        ...
                        { "data-toggle": "tooltip",
                            ...
                            title: "This element indicates if the changes you made saved correctly on our servers." },
                        status
                    )
                ),
                React.createElement(
                    "div",
                    { className: "col-lg-4 col-md-12 col-sm-12 col-xs-12 leftSide" },
                    React.createElement(
                        "div",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    "a",
                                    { href: "#workflowTab", "aria-controls": "workflowTab", role: "tab", "data-toggle": "tab" },
                                    "Workflow"
                                )
                            ),
                            React.createElement(
                                ...
                                React.createElement(
                                    "a",
                                    { href: "#settingsTab", "aria-controls": "settingsTab", role: "tab", "data-toggle": "tab" },
                                    "Settings"
                                )
                            ),
                            React.createElement(
                                ...
                                React.createElement(
                                    "a",
                                    { href: "#exportTab", "aria-controls": "exportTab", role: "tab", "data-toggle": "tab" },
                                    "Export"
                                )
                            )
                        ),
                    ...
                    React.createElement(WorkflowInputValues, { inputs: target.state.inputs,
                        inputsValues: this.state.inputsValues,
                        inputsStatus: target.state.inputsStatus,
                        inputValueChanged: target.runInputValueChanged }),
                    React.createElement(ComponentCatalog, { clickOnComponent: target.addComponent, forking: target.state.forking })
                ),
                React.createElement(
                    "div",
                    { className: "col-lg-8 col-md-12 col-sm-12 col-xs-12 rightSide" },
                    React.createElement(
                        "div",
                        { id: "executionPanel", style: { paddingBottom: "30px", overflowY: "auto", position: "fixed", bottom: "-150px", width: "100%", right: 0, height: "100px", background: "rgba(255,255,255,0.95)", zIndex: 2147483001 } },
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "div",
                            { role: "tabpanel", className: "tab-pane fade in active", id: "workflowTab" },
                            contentWorkflow
                        ),
                        React.createElement(SettingsTab, { identifer: target.state.identifier, name: target.state.name, loading: target.state.loading, changeName: target.changeName }),
                        React.createElement(ExportTab, { loading: target.state.loading, id: target.state.identifier, inputs: target.state.inputs })
                    )
                )
            );
        }
