    ...
    var InputTypeContent = React.createClass({
        ...
        render: function () {
            return React.createElement(
                ...
                React.createElement(
                    "select",
                    { className: "form-control input-xs type",
                ...
                React.createElement(
                    ...
                    { htmlFor: "type",
                        ...
                        style: {
                            ...
                            color: "white" } },
                    React.createElement("i", { className: "fa fa-angle-down", style: { marginLeft: "-4px", height: "100%" } })
                )
            );
        }
    });
        ...
        render: function () {
            ...
            if (this.state.selectedType.length) {
                ...
                if (this.props.displayOptionalButton) {
                    ...
                    optionalButton = React.createElement(
                        "div",
                        { className: "label label-info checkbox", style: { borderRadius: "0px", textDecoration: "none" } },
                        React.createElement(
                            "label",
                            null,
                ...
                if (this.props.editable) {
                    name = React.createElement(
                        "div",
                        { style: { background: "#1194F6", color: "white", display: "inline-block", lineHeight: "16px", height: "17px" } },
                        React.createElement("input", { type: "text", onChange: this.nameInputChanged.bind(null, this.props.inputName), defaultValue: this.props.inputName, style: { height: "17px", lineHeight: "17px", marginLeft: "3px", background: "#1194F6", color: "white", fontSize: "75%", fontWeight: "bold", paddingLeft: "5px", boxShadow: "none" } })
                    );
                }
                ...
                content = React.createElement(
                    "span",
                    { className: "input" },
                    React.createElement(InputTypeContent, { index: "0",
                    ...
                    this.state.selectedType.slice(1).map(function (row, i) {
                        ...
                        return React.createElement(InputTypeContent, { index: index,
                            value: row,
                    ...
                    React.createElement(
                        "span",
                        { className: "remove", style: { cursor: "pointer" }, onClick: this.remove.bind(null, this.props.inputName) },
