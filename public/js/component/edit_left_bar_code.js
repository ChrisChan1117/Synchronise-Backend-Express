...
dependenciesLoader(["$", "React", "ReactDOM", "_", "Loader", "TimeAgo", "CodeMirror", "urlH", "InputType"], function () {
    var interval = window.setInterval(function () {
        if (typeof CodeMirror.modes.javascript != "undefined" && typeof CodeMirror.hint != "undefined") {
            execute();
    ...
    function execute() {
        ...
        var Inputs = React.createClass({
            ...
            render: function render() {
                ...
                if (this.props.isOwner) {
                    inputsExplanation = React.createElement(
                        "div",
                        { style: { marginTop: "15px", textAlign: "center" } },
                        React.createElement(
                            "small",
                            { style: { whiteSpace: "normal", fontSize: "small", fontFamily: "monospace" } },
                            "Inputs are special parameters that your component can receive. They are accessible using the keyword ",
                            React.createElement(
                                "code",
                                null,
                                "Input"
                            ...
                            React.createElement(
                                "a",
                                { href: "https://www.synchronise.io/docs?#80d15352-5e3e-486a-bcea-6cb64a2a9b30", alt: "Documentation inputs" },
                                " Documentation"
                            ),
                ...
                var addInputButton = "";
                if (this.props.isOwner) {
                    addInputButton = React.createElement(
                        "div",
                        { id: "addInputButton", className: this.state.stateAddButton, onClick: this.addButton },
                        React.createElement(
                            "i",
                ...
                return React.createElement(
                    ...
                    React.createElement("div", { id: "separatorInputCode" })
                );
            }
        });
        ...
        var Outputs = React.createClass({
            ...
            render: function render() {
                ...
                if (this.props.isOwner) {
                    outputExplanation = React.createElement(
                        "div",
                        { style: { textAlign: "center" } },
                        React.createElement(
                            "small",
                            { style: { whiteSpace: "normal", fontSize: "small", fontFamily: "monospace" } },
                            "Outputs are special parameters that your component can return. You can set the value of an Output using the keyword ",
                            React.createElement(
                                "code",
                                null,
                                "Output"
                            ...
                            React.createElement(
                                "a",
                                { href: "https://www.synchronise.io/docs?#41593f3d-227d-41d3-8ba5-b42359421bae", alt: "Documentation outputs" },
                                "Documentation"
                            ),
                            " for more information"
                        )
                ...
                var addOutputButton = "";
                if (this.props.isOwner) {
                    addOutputButton = React.createElement(
                        "div",
                        { id: "addOutputButton", className: this.state.stateAddButton, onClick: this.addButton },
                        React.createElement(
                            "i",
                            { className: "fa fa-plus " + this.state.stateAddButton },
                            " ",
                ...
                return React.createElement(
                    "div",
                    { className: "col-xs-12" },
                    React.createElement("div", { id: "separatorOutputCode" }),
                    React.createElement(
                        "div",
                        { className: "card inline-form" },
                        React.createElement(
        ...
        Code = React.createClass({
            ...
            componentDidMount: function componentDidMount() {
                        ...
                        var i = r[a];if (i) {
                            var c, n;if ((c = [], i.evidence)) {
                                var o = c[i.line];if (!o) {
                                    ...
                                    var s = i.character;o.forEach(function (r) {
                                        s > r && (s -= 1);
                                    }), i.character = s;
                                }
                            }var v = i.character - 1,
                                f = v + 1;i.evidence && (n = i.evidence.substring(v).search(/.\b/), n > -1 && (f += n)), i.description = i.reason, i.start = i.character, i.end = f, e.push({ message: i.description, severity: i.severity, from: CodeMirror.Pos(i.line - 1, v), to: CodeMirror.Pos(i.line - 1, f) });
                        }
                    }
                }
                ...
                CodeMirror.hint.javascript = function (cm) {
                    ...
                    function anyword(options) {
                        ...
                        var cur = code.getCursor(),
                            curLine = code.getLine(cur.line);
                        var end = cur.ch,
                            start = end;
                        ...
                        for (var dir = -1; dir <= 1; dir += 2) {
                            var line = cur.line,
                                endLine = Math.min(Math.max(line + dir * range, code.firstLine()), code.lastLine()) + dir;
                            for (; line != endLine; line += dir) {
                                var text = code.getLine(line),
                                    m;
            ...
            render: function render() {
                ...
                if (!this.state.loading) {
                    ...
                    if (this.props.component.user_id == Synchronise.User.current().id) {
                        if (this.state.saving) {
                            savingStatus = React.createElement(
                                "span",
                                { className: "label label-primary", style: { position: "absolute", right: right, marginTop: marginTop, zIndex: 1 } },
                                "Saving"
                            );
                        } else {
                            if (!this.state.error) {
                                savingStatus = React.createElement(
                                    "span",
                                    { className: "label label-success", style: { position: "absolute", right: right, marginTop: marginTop, zIndex: 1 } },
                                    "Saved"
                                );
                            } else {
                                savingStatus = React.createElement(
                                    "span",
                                    { className: "label label-danger", style: { position: "absolute", right: right, marginTop: marginTop, zIndex: 1 } },
                                    "Syntax error"
                                );
                            }
                        }
                    ...
                    if (this.props.component) {
                        inputs = React.createElement(
                            "div",
                            { className: "row-fluid", id: "inputs" },
                            React.createElement(Inputs, { inputs: this.props.component.inputs,
                        ...
                        outputs = React.createElement(
                            "div",
                            { className: "row-fluid", id: "outputs" },
                            React.createElement("br", null),
                            React.createElement(Outputs, { outputs: this.props.component.outputs,
                ...
                language = React.createElement(
                    "span",
                    { className: "label label-default", style: { position: "absolute", marginTop: marginTop, right: right, zIndex: 1 } },
                    "Node.JS"
                );
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "col-xs-12" },
                                React.createElement("textarea", { id: "code_editor" })
                            )
                        ),
                        React.createElement(
                            "div",
                            ...
                            React.createElement(
                                "div",
                                { className: "col-xs-12", style: { textAlign: "right" } },
                                savingStatus,
                                language
                            )
                        ),
