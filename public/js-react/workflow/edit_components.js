                ...
                <ol id="listOfComponentsInFlow">
                    {target.props.components.map(function(row, index){
                        if(target.props.componentsData[row.id_component]){
                            ...
                            return (
                                <li className="liForComponent">
                                    <div className={"col-lg-12 col-md-12 col-sm-12 col-xs-12 component compAt" + index + " card displayed"} style={{marginBottom: "20px", marginTop: "20px", zIndex: 500-index}}>
                                        <div className="header" style={{background: "white"}}>
                                            <legend className="title" style={{color: "black"}}><span className="orderLabel" style={{borderColor: "black", color: "black"}}>{index+1}</span>Undefined</legend>
                                            <i className="fa fa-times remove" style={{color: "black", cursor: "pointer"}} onClick={target.props.removeComponent.bind(null, index)}></i>
                                        </div>
                                        <div className="settings" style={{background: "white", padding: "10px"}}>
