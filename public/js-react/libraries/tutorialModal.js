        ...
        render: function(){
            ...
            return (
                <div style={{display: display}}>
                    <div id="shadow" style={{position: "fixed", "left": 0, "top": 0, background: "rgba(0,0,0,0.5)", width: "100%", height: "100%", zIndex: 1001}}></div>
                    <div id="tutorialBlock" style={{position: "fixed", width: "80%", maxHeight: "80%", overflowY: "auto", zIndex: 1002, top: "10%", left: "10%", background: "white", borderRadius: "5px", boxShadow: "0 1px 1px rgba(0,0,0,.15) !important", padding: "10px"}}>
                        {content}
                    </div>
                </div>
            );
